...
export default function DaftarHarga(props) {
    const { data: daftarHarga, meta, links, filtered } = props.daftarHarga;
    ...
    return (
        <div>
            ...
            <div>
                <AlertDialogs
                    title={"Tambah Jenis Daftar Harga"}
                    open={openDialog}
                ...
                <AlertDialogs
                    title={"Delete Jenis Daftar Harga"}
                ...
                >
                    ...
                    <div className="flex gap-1 justify-end my-4">
                        <AddButton
                            onClick={() =>
                                router.delete(
                                    route("admin.daftar-harga-delete", {
                                        id: model.id,
                                    }),
                                    {
                                        onSuccess: () => {
            ...
            <div className="flex gap-x-4 justify-between items-center text-white">
                <AddButton
                    ...
                    title={"tambah Jenis Daftar Harga"}
                />
                <SearchInput filtered={filtered} link={"admin.daftar-harga"} />
            </div>
                        ...
                        >
                            <CardView>
                                ...
                                <p className="capitalize  text-[8pt]">
                                    jenis Penumpang :{" "}
                                    <span className="uppercase">
                                        {item.jenis_penumpang.nama}
                                    </span>
                                </p>
                                <p className="capitalize  text-[8pt]">
                                    Harga Tiket : {item.harga}
                                </p>
                            </CardView>
...
DaftarHarga.layout = (page) => (
    <AdminLayout children={page} titlePage={"Daftar Harga"} />
);
