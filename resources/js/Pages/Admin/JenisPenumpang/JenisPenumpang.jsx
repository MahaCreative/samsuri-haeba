...
export default function JenisPenumpang(props) {
    const {
        data: jenisPenumpang,
        meta,
        links,
        filtered,
    } = props.jenisPenumpang;
                ...
                >
                    ...
                    <div className="flex gap-1 justify-end my-4">
                        <AddButton
                            onClick={() =>
                                router.delete(
                                    route("admin.jenis-penumpang-delete", {
                                        id: model.id,
                                    }),
                                    {
                                        onSuccess: () => {
...
JenisPenumpang.layout = (page) => (
    <AdminLayout children={page} titlePage={"Jenis Penumpang"} />
);
