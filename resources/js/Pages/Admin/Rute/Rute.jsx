...
export default function Rute(props) {
    const { data: rute, meta, links, filtered } = props.rute;
        ...
        <div>
            ...
            <div className="flex justify-between items-center text-white">
                <AddButton
                    ...
                    title={"tambah rute"}
                />
                <SearchInput filtered={filtered} link={"admin.rute"} />
            </div>
...
Rute.layout = (page) => <AdminLayout children={page} titlePage={"Rute"} />;
