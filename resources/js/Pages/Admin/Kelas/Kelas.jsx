...
export default function Kelas(props) {
    const { data: kelas, meta, links, filtered } = props.kelas;
        ...
        <div>
            ...
            <div className="flex justify-between items-center text-white">
                <AddButton
                    ...
                    title={"tambah Kelas"}
                />
                <SearchInput filtered={filtered} link={"admin.kelas"} />
            </div>
...
Kelas.layout = (page) => <AdminLayout children={page} titlePage={"Kelas"} />;
