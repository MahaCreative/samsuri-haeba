...
export default function JadwalKapal(props) {
    const { data: jadwalKapal, meta, links, filtered } = props.jadwalKapal;
        ...
        <div>
                ...
                >
                    ...
                    <div className="flex gap-1 justify-end my-4">
                        <AddButton
                            onClick={() =>
                                router.delete(
                                    route("admin.jadwal-kapal-delete", {
                                        id: model.id,
                                    }),
                                    {
                                        onSuccess: () => {
            ...
            <div className="flex gap-x-4 justify-between items-center text-white">
                <AddButton
                    ...
                    title={"tambah Jadwal Kapal"}
                />
                <SearchInput filtered={filtered} link={"admin.jadwal-kapal"} />
            </div>
                        ...
                        >
                            <CardView>
                                ...
                                <p className="text-[8pt]">
                                    Rute: {item.rute.kota_awal} ->{" "}
                                    {item.rute.kota_tujuan}
                                </p>
                            ...
                            {item.status_keberangkatan != "berangkat" && (
...
JadwalKapal.layout = (page) => (
    <AdminLayout children={page} titlePage={"Jadwal Kapal"} />
);
